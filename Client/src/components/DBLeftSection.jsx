      ...
      <NavLink to='/' className='flex items-center justify-start px-4  gap-2'>
        ...
        <ul className='flex flex-col gap-2'>
          <NavLink to='/dashboard/home' className={({ isActive }) => isActive ? `${isActiveStyles} px-2 py-2 border-l-8 border-red-500` : isNoActiveStyles}> 
            ...
            <NavLink to='/dashboard/items' className={({ isActive }) => isActive ? `${isActiveStyles} px-2 py-2 border-l-8 border-red-500` : isNoActiveStyles}> 
            Items
            </NavLink>
            <NavLink to='/dashboard/newItem' className={({ isActive }) => isActive ? `${isActiveStyles} px-2 py-2 border-l-8 border-red-500` : isNoActiveStyles}> 
            New Item
            </NavLink>
            <NavLink to='/dashboard/users' className={({ isActive }) => isActive ? `${isActiveStyles} px-2 py-2 border-l-8 border-red-500` : isNoActiveStyles}> 
            Users
            </NavLink>
